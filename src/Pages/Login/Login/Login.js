...
const Login = () => {
    ...
    return (
        <div className='container w-50 mx-auto'>
            ...
            {errorElement}
            <p className='mx-auto w-75'>New to Genius Car? <Link to="/register" className='text-danger pe-auto text-decoration-none' onClick={navigateRegister}>Please Register</Link> </p>
